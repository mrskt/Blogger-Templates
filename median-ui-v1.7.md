        ...
        <header class='mainH flex cInherit noPrint'>
          ...
          <div class='headL flex shrink'>
            ...
            <b:section class='headT notranslate' id='header-title' maxwidgets='1' showaddelement='false'>
              <b:widget id='Header1' locked='true' title='UTest (Header)' type='Header' version='2' visible='true'>
                <b:widget-settings>
                    ...
                    <b:section class='flex column' id='main-widget' showaddelement='true'>
                      ...
                      <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
                        <b:widget-settings>
                          ...
                          <b:widget-setting name='style.textcolor'>#3740ff</b:widget-setting>
                          <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                          <b:widget-setting name='authorLabel'>Oleh</b:widget-setting>
                          <b:widget-setting name='showCommentLink'>true</b:widget-setting>
                          <b:widget-setting name='style.urlcolor'>#f9f9fb</b:widget-setting>
                          <b:widget-setting name='showAuthor'>true</b:widget-setting>
                          <b:widget-setting name='style.linkcolor'>#fffdfc</b:widget-setting>
